          ...
          >
                    ...
                    <form className="space-y-4">
                      ...
                      <div className="flex flex-col justify-items-center gap-3">
                        ...
                        <div>
                          ...
                          <select className="w-full rounded border border-white bg-black p-2 text-white">
            ...
            <div className="bg-black px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                type="button"
                onClick={onClose}
                className="inline-flex w-full cursor-pointer justify-center rounded-md bg-green-800 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-500 sm:ml-3 sm:w-auto"
              >
                Adicionar
              </button>
              <button
